...
import { iosButtonStyle, pulseRingStyle } from '../components/shared/sharedStyles';
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Microphone button section - In flow */}
        <Box
          sx={{
            display: 'flex',
            flexDirection: 'column',
          ...
          >
            ...
            <IconButton
              ...
              sx={{
                ...
                borderRadius: '50%',
                background: 'linear-gradient(135deg, #14B8A6 0%, #0D9488 100%)',
                boxShadow: '0 12px 20px -3px rgba(20, 184, 166, 0.4), 0 6px 8px -2px rgba(20, 184, 166, 0.25)',
                display: 'flex',
                alignItems: 'center',
                justifyContent: 'center',
                zIndex: 1,
